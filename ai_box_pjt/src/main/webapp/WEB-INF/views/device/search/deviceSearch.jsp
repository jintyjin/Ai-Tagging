...
$(document).ready(function () {
	...
	$(".grid").jqxGrid({
		...
		columns: [
			{ text: '번호', datafield: 'idx', width: '4%', hidden:true},
            {
			...
			{ text: 'IP', datafield: 'dev_ip', width: '25%', editable: false },
			{ text: '포트', datafield: 'dev_port', width: '22%', editable: false },
			{ text: '모델명', datafield: 'dev_manufacturer', width: '25%', editable: false },
			{ text: 'MAC 주소', datafield: 'dev_mac', width: '25%'/* '216.41px' */, editable: false }
		]
	});
